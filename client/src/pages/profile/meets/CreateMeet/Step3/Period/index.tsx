...
import { Period as PeriodInt } from "interfaces/meet";
import { FaRegTrashAlt, FaPlus } from "react-icons/fa";
import Modal from "components/ui/Modal";

interface PeriodProps {
  onRemove?: (dayId: string, id: string) => void;
  onEdit?: (dayId: string, period: PeriodInt) => void;
  onAdd?: (dayId: string, period: PeriodInt) => void;
  isAdding?: boolean;
  isEditing?: boolean;
  isDeleting?: boolean;
  values?: PeriodInt;
...
const Period: FC<PeriodProps> = ({
  ...
  const [period, setPeriod] = useState<PeriodInt>(values || defaultPeriod);
